...
type TripServiceGetTrips = {
  readonly methodName: string;
  readonly service: typeof TripService;
  readonly requestStream: false;
  readonly responseStream: false;
  readonly requestType: typeof trip_pb.GetTripsRequest;
  readonly responseType: typeof trip_pb.GetTripsResponse;
};
...
export class TripService {
  ...
  static readonly GetTrips: TripServiceGetTrips;
}
...
export class TripServiceClient {
  ...
  getTrips(
    requestMessage: trip_pb.GetTripsRequest,
    metadata: grpc.Metadata,
    callback: (error: ServiceError|null, responseMessage: trip_pb.GetTripsResponse|null) => void
  ): UnaryResponse;
  getTrips(
    requestMessage: trip_pb.GetTripsRequest,
    callback: (error: ServiceError|null, responseMessage: trip_pb.GetTripsResponse|null) => void

...
type LocationServiceUpdateDriverLocation = {
  readonly methodName: string;
  readonly service: typeof LocationService;
...
export class LocationService {
  ...
  static readonly UpdateDriverLocation: LocationServiceUpdateDriverLocation;
...
export class LocationServiceClient {
  ...
  updateDriverLocation(
    requestMessage: location_pb.DriverTelemetry,
    metadata: grpc.Metadata,
    callback: (error: ServiceError|null, responseMessage: location_pb.Ack|null) => void
  ): UnaryResponse;
  updateDriverLocation(
    requestMessage: location_pb.DriverTelemetry,
    callback: (error: ServiceError|null, responseMessage: location_pb.Ack|null) => void

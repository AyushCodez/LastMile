...
export class GetTripsRequest extends jspb.Message {
  getDriverId(): string;
  setDriverId(value: string): void;
  ...
  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): GetTripsRequest.AsObject;
  static toObject(includeInstance: boolean, msg: GetTripsRequest): GetTripsRequest.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: GetTripsRequest, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): GetTripsRequest;
  static deserializeBinaryFromReader(message: GetTripsRequest, reader: jspb.BinaryReader): GetTripsRequest;
}
...
export class GetTripsResponse extends jspb.Message {
  clearTripsList(): void;
  getTripsList(): Array<Trip>;
  setTripsList(value: Array<Trip>): void;
  addTrips(value?: Trip, index?: number): Trip;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): GetTripsResponse.AsObject;
  static toObject(includeInstance: boolean, msg: GetTripsResponse): GetTripsResponse.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: GetTripsResponse, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): GetTripsResponse;
  static deserializeBinaryFromReader(message: GetTripsResponse, reader: jspb.BinaryReader): GetTripsResponse;
}

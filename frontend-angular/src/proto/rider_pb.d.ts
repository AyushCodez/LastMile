...
export class GetRideHistoryRequest extends jspb.Message {
  getUserId(): string;
  setUserId(value: string): void;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): GetRideHistoryRequest.AsObject;
  static toObject(includeInstance: boolean, msg: GetRideHistoryRequest): GetRideHistoryRequest.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: GetRideHistoryRequest, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): GetRideHistoryRequest;
  static deserializeBinaryFromReader(message: GetRideHistoryRequest, reader: jspb.BinaryReader): GetRideHistoryRequest;
}

export namespace GetRideHistoryRequest {
  export type AsObject = {
    userId: string,
  }
}

export class RideHistoryResponse extends jspb.Message {
  clearRidesList(): void;
  getRidesList(): Array<RideStatus>;
  setRidesList(value: Array<RideStatus>): void;
  addRides(value?: RideStatus, index?: number): RideStatus;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): RideHistoryResponse.AsObject;
  static toObject(includeInstance: boolean, msg: RideHistoryResponse): RideHistoryResponse.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: RideHistoryResponse, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): RideHistoryResponse;
  static deserializeBinaryFromReader(message: RideHistoryResponse, reader: jspb.BinaryReader): RideHistoryResponse;
}

export namespace RideHistoryResponse {
  export type AsObject = {
    ridesList: Array<RideStatus.AsObject>,
  }
}

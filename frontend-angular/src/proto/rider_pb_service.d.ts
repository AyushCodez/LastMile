...
type RiderServiceGetRideHistory = {
  readonly methodName: string;
  readonly service: typeof RiderService;
  readonly requestStream: false;
  readonly responseStream: false;
  readonly requestType: typeof rider_pb.GetRideHistoryRequest;
  readonly responseType: typeof rider_pb.RideHistoryResponse;
};
...
export class RiderService {
  ...
  static readonly GetRideHistory: RiderServiceGetRideHistory;
}
...
export class RiderServiceClient {
  ...
  getRideHistory(
    requestMessage: rider_pb.GetRideHistoryRequest,
    metadata: grpc.Metadata,
    callback: (error: ServiceError|null, responseMessage: rider_pb.RideHistoryResponse|null) => void
  ): UnaryResponse;
  getRideHistory(
    requestMessage: rider_pb.GetRideHistoryRequest,
    callback: (error: ServiceError|null, responseMessage: rider_pb.RideHistoryResponse|null) => void
